...
int main(int argc, char *argv[]) {
    ...
    CL_classic_caesar_t *cipher = CL_classic_caesar_new(encoder);

    printf("%s\n", (char*)CL_classic_caesar_encrypt(cipher, CL_MODE_ENCRYPT, key, message, message));
    printf("%s\n", (char*)CL_classic_caesar_encrypt(cipher, CL_MODE_DECRYPT, key, message, message));
